 ...
 */
final class TeaCollectionsController extends AdminController
{
    /**
     * {@inheritdoc}
     */
    ...
    public function actionCreate(string $redirect = null): Response|string
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            ...
            return match ($redirect) {
                ...
                'index' => $this->redirect(UserUrl::setFilters(TeaCollectionsSearch::class)),
    ...
    public function actionDelete(int $id): Response
    {
        ...
        return $this->redirect(UserUrl::setFilters(TeaCollectionsSearch::class));
    }
     ...
     * @throws NotFoundHttpException if the model cannot be found
     */
    private function findModel(int $id): TeaCollections
    {
        if (($model = TeaCollections::findOne($id)) !== null) {
            return $model;
        }
    ...
    public function actions(): array
    {
        return [
            'change' => [
                ...
                'modelClass' => TeaCollections::class
            ]
        ];
    }
}
