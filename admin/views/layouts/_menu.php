...
use common\models\{ExportListSearch, FeedbackSearch, NewsSearch, TeaCollectionsSearch, TeaSearch, TextSearch};
        ...
        [
            ...
            'items' => [
                ...
                [
                    ...
                    'url' => UserUrl::setFilters(TeaCollectionsSearch::class, ['/tea-collections/index'])
                ],
                [
                    'label' => Yii::t('app', 'Tea'),
                    'url' => UserUrl::setFilters(TeaSearch::class, ['/tea/index'])
                ],
                [
